...
// refusal - "that is your own address", "admin access required" - reached
// the person as "Edge Function returned a non-2xx status code". The body the
// function sent is on the raw Response in `error.context`.
